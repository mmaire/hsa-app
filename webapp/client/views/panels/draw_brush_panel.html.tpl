...
<div
   ...
   <div id="{{prefix}}-brush-modes" class="brush-modes">
      ...
      <div>
         ...
         <label
            ...
            title="Erase Existing Mark">
         </label>
      </div>
   </div>
   <div id="draw-brush-modes-label" class="text-tiny">
      Mode
   </div>
   <div
   ...
   <div id="{{prefix}}-brush-touchup" class="brush-touchup">
      ...
      <label
         id="touchup-icon"
         for="{{prefix}}-touchup"
         title="Check to Disable Automatic Fill-In">
      </label>
   </div>
</div>
